...
export const messages: Messages = {
  ...
  'push.image_desktop_note': '데스크톱 브라우저에서는 그림이 표시되지 않을 수 있습니다.',
  'push.image_placeholder': 'https://example.com/photo.jpg',
  'push.image_none': '이미지 없음',
  'push.link_label': '링크',
  'push.link_hint': '알림을 누르면 여는 곳입니다.',
  'push.content_too_long': '너무 길어 보낼 수 없습니다 — 이미지나 링크 주소를 줄이세요.',
  ...
  'push.actions_hint': '알림을 펼쳐야 버튼이 보이는 기기도 있고 아예 보이지 않는 기기도 있습니다.',
  ...
  'push.result_no_token': '그 기기는 알림을 받고 있지 않습니다. 그 기기에서 알림을 켜 주세요.',
  'push.result_rejected': 'Firebase가 그 기기의 토큰을 거부해 그 기기의 알림이 꺼졌습니다. 그 기기에서 다시 켜 주세요.',
  'push.result_failed': '지금은 Firebase에 그 기기로 보내지 못했습니다. 잠시 후 다시 시도하세요.',
  ...
  'push.allow_off_desc': '이 기기가 더 이상 받지 않습니다. 알림 권한은 그대로입니다.',
  'push.allow_denied': '알림이 차단돼 있습니다. 설정에서 다시 켜 주세요.',
  // 차단된 상태에서 할 수 있는 일을 내놓는다 — **앱만 이 버튼을 갖는다**(브라우저에는 사이트 권한 설정을 여는 API가 없다
  'push.allow_open_settings': '설정 열기',
  'push.allow_unsupported': '여기서는 알림을 받을 수 없습니다.',
