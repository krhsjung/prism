...
export const messages: Messages = {
  ...
  'push.content_too_long': '長すぎて送信できません — 画像かリンクのアドレスを短くしてください。',
  ...
  'push.actions_hint': '通知を展開しないとボタンが表示されない端末や、まったく表示されない端末もあります。',
  ...
  'push.result_no_token': 'その端末は通知を受け取っていません。その端末で通知をオンにしてください。',
  'push.result_rejected': 'Firebase がその端末のトークンを拒否したため通知はオフになりました。その端末でもう一度オンにしてください。',
  'push.result_failed': 'その端末への送信が今はできませんでした。しばらくしてからもう一度お試しください。',
  ...
  'push.allow_off_desc': 'この端末は受信しなくなります。通知の権限はそのままです。',
  'push.allow_denied': '通知がブロックされています。設定でオンに戻してください。',
  // 차단된 상태에서 할 수 있는 일을 내놓는다 — **앱만 이 버튼을 갖는다**(브라우저에는 사이트 권한 설정을 여는 API가 없다
  'push.allow_open_settings': '設定を開く',
  'push.allow_unsupported': 'ここでは通知を受け取れません。',
